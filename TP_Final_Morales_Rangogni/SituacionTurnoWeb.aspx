<%@ Page Title="Especialidad" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SituacionTurnoWeb.aspx.cs" Inherits="TP_Final_Morales_Rangogni.SituacionTurnoWeb" Debug="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContentLogin" runat="server">
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="upEspecialidad">
        <ContentTemplate>
            <div class="tab-bar">
                <a href="#SITUACION">SITUACION TURNO</a>
            </div>

            <div class="content">
                <div class="header bg-blue">
                    <asp:GridView ID="dgvSituacion" DataKeyNames="IdSituacion" AutoGenerateColumns="false" OnRowCommand="dgvSituacion_RowCommand" CssClass="highlight responsive-table" runat="server">
                        <Columns>
                            <asp:BoundField HeaderText="Id" DataField="IdSituacion" />
