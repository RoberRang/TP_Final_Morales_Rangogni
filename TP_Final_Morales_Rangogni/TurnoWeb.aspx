...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentLogin" runat="server">
    <section>
        ...
        <div class="content">
            <div>
                <asp:Menu runat="server" ID="mnTurnos" Orientation="Horizontal" StaticMenuItemStyle-CssClass="tab" StaticSelectedStyle-CssClass="tab-bar" OnMenuItemClick="mnTurnos_MenuItemClick" CssClass="tab-bar">
                    <Items>
                        <asp:MenuItem Text="Nuevo Turno" Value="0" Selected="true"></asp:MenuItem>
                        <asp:MenuItem Text="Listar Turnos" Value="1"></asp:MenuItem>
                    </Items>
                </asp:Menu>
            </div>
